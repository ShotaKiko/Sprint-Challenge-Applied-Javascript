class TabLink {
  constructor(tabElement){
    ...
    this.tabDataElement = document.querySelectorAll(`.card[data-tab='${this.tabData}']`); 

//console.log(this.tabData)
//console.log(this.tabDataElement)
...
//console.log(this.tabData)
    ...
    this.cards = Array.from(this.cards).map(x => new TabCard(this.cards));
...
class TabCard {
  ...
  selectCard(){
   ...
   this.cardItem = document.querySelectorAll(`.card[data-tab='${this.cardElement}']`)
